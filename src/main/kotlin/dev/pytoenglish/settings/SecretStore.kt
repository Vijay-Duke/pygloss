...
class SecretStore {
    ...
    private val credentialAttributes: CredentialAttributes = CredentialAttributes(
        generateServiceName("py-to-english", CREDENTIAL_KEY)
    )
    ...
    companion object {
        ...
        private const val CREDENTIAL_KEY = "dev.pytoenglish.apiKey"
        private const val CREDENTIAL_USER = "py-to-english"
